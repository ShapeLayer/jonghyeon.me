    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br1, file$4, 6, 34, 299);
    			attr_dev(p1, "class", "svelte-19h2xjl");
    			add_location(p1, file$4, 6, 6, 271);
    			add_location(br2, file$4, 7, 30, 370);
    			attr_dev(p2, "class", "svelte-19h2xjl");
    			add_location(p2, file$4, 7, 6, 346);
    			add_location(br3, file$4, 8, 34, 450);
    			attr_dev(p3, "class", "svelte-19h2xjl");
    			add_location(p3, file$4, 8, 6, 422);
    			attr_dev(p4, "class", "svelte-19h2xjl");
    			add_location(p4, file$4, 9, 6, 487);
    			add_location(br4, file$4, 10, 9, 516);
    			attr_dev(p5, "class", "svelte-19h2xjl");
    			add_location(p5, file$4, 10, 6, 513);
    			attr_dev(p6, "class", "svelte-19h2xjl");
    			add_location(p6, file$4, 11, 6, 531);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span0 = element("span");
    			span0.textContent = "2022.07-2024.01";
    			br0 = element("br");
    			t6 = text("\n          ⇒ ");
    			...
    			add_location(br0, file$2, 10, 82, 394);
    			add_location(br1, file$2, 11, 23, 422);
    			...
    			add_location(h31, file$2, 16, 6, 530);
    			attr_dev(span1, "class", "datetime svelte-13zdxo0");
    			add_location(span1, file$2, 18, 19, 596);
    			attr_dev(li1, "class", "svelte-13zdxo0");
    			add_location(li1, file$2, 18, 8, 585);
    			attr_dev(span2, "class", "datetime svelte-13zdxo0");
    			add_location(span2, file$2, 19, 39, 686);
    			attr_dev(li2, "class", "svelte-13zdxo0");
    			add_location(li2, file$2, 19, 8, 655);
    			add_location(ul1, file$2, 17, 6, 572);
    			attr_dev(div1, "id", "careers__education");
    			attr_dev(div1, "class", "careers__sections svelte-13zdxo0");
    			add_location(div1, file$2, 15, 4, 468);
    			attr_dev(h32, "class", "subtitle svelte-13zdxo0");
    			add_location(h32, file$2, 23, 6, 819);
    			attr_dev(span3, "class", "datetime svelte-13zdxo0");
    			add_location(span3, file$2, 25, 35, 896);
    			attr_dev(li3, "class", "svelte-13zdxo0");
    			add_location(li3, file$2, 25, 8, 869);
    			add_location(ul2, file$2, 24, 6, 856);
    			attr_dev(div2, "id", "careers__education");
    			attr_dev(div2, "class", "careers__sections svelte-13zdxo0");
    			add_location(div2, file$2, 22, 4, 757);
    			attr_dev(h33, "class", "subtitle svelte-13zdxo0");
    			add_location(h33, file$2, 29, 6, 1035);
    			attr_dev(a0, "href", "https://name.ho9.me");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$2, 32, 10, 1104);
    			attr_dev(span4, "class", "datetime svelte-13zdxo0");
    			add_location(span4, file$2, 32, 70, 1164);
    			add_location(br2, file$2, 32, 107, 1201);
    			attr_dev(li4, "class", "svelte-13zdxo0");
    			add_location(li4, file$2, 31, 8, 1089);
    			attr_dev(span5, "class", "datetime svelte-13zdxo0");
    			add_location(span5, file$2, 36, 46, 1299);
    			add_location(br3, file$2, 36, 91, 1344);
    			attr_dev(li5, "class", "svelte-13zdxo0");
    			add_location(li5, file$2, 35, 8, 1248);
    			attr_dev(a1, "href", "https://hccc2022.github.io");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$2, 40, 10, 1419);
    			attr_dev(span6, "class", "datetime svelte-13zdxo0");
    			add_location(span6, file$2, 40, 100, 1509);
    			add_location(br4, file$2, 40, 137, 1546);
    			attr_dev(li6, "class", "svelte-13zdxo0");
    			add_location(li6, file$2, 39, 8, 1404);
    			attr_dev(a2, "href", "https://iwfcv2023.github.io");
    			add_location(a2, file$2, 44, 10, 1623);
    			attr_dev(span7, "class", "datetime svelte-13zdxo0");
    			add_location(span7, file$2, 44, 74, 1687);
    			add_location(br5, file$2, 44, 119, 1732);
    			attr_dev(li7, "class", "svelte-13zdxo0");
    			add_location(li7, file$2, 43, 8, 1608);
    			attr_dev(a3, "href", "https://github.com/ShapeLayer");
    			attr_dev(a3, "target", "_blank");
    			add_location(a3, file$2, 47, 23, 1809);
    			attr_dev(li8, "class", "svelte-13zdxo0");
    			add_location(li8, file$2, 47, 8, 1794);
    			add_location(ul3, file$2, 30, 6, 1076);
    			attr_dev(div3, "id", "careers__procects");
    			attr_dev(div3, "class", "careers__sections svelte-13zdxo0");
    			add_location(div3, file$2, 28, 4, 974);
    			attr_dev(h34, "class", "subtitle svelte-13zdxo0");
    			add_location(h34, file$2, 51, 6, 1981);
    			attr_dev(span8, "class", "datetime svelte-13zdxo0");
    			add_location(span8, file$2, 53, 31, 2062);
    			attr_dev(li9, "class", "svelte-13zdxo0");
    			add_location(li9, file$2, 53, 8, 2039);
    			add_location(sup, file$2, 54, 56, 2161);
    			attr_dev(span9, "class", "datetime svelte-13zdxo0");
    			add_location(span9, file$2, 54, 70, 2175);
    			attr_dev(li10, "class", "svelte-13zdxo0");
    			add_location(li10, file$2, 54, 8, 2113);
    			attr_dev(span10, "class", "datetime svelte-13zdxo0");
    			add_location(span10, file$2, 56, 44, 2278);
    			add_location(br6, file$2, 56, 81, 2315);
    			add_location(br7, file$2, 57, 27, 2347);
    			attr_dev(li11, "class", "svelte-13zdxo0");
    			add_location(li11, file$2, 55, 8, 2229);
    			attr_dev(span11, "class", "datetime svelte-13zdxo0");
    			add_location(span11, file$2, 61, 47, 2488);
    			add_location(br8, file$2, 61, 84, 2525);
    			add_location(br9, file$2, 62, 27, 2557);
    			attr_dev(li12, "class", "svelte-13zdxo0");
    			add_location(li12, file$2, 60, 8, 2436);
    			add_location(ul4, file$2, 52, 6, 2026);
    			attr_dev(div4, "id", "careers__achievements");
    			attr_dev(div4, "class", "careers__sections svelte-13zdxo0");
    			add_location(div4, file$2, 50, 4, 1916);
    			attr_dev(h35, "class", "subtitle svelte-13zdxo0");
    			add_location(h35, file$2, 68, 6, 2731);
    			attr_dev(span12, "class", "datetime svelte-13zdxo0");
    			add_location(span12, file$2, 71, 53, 2845);
    			add_location(br10, file$2, 71, 90, 2882);
    			attr_dev(li13, "class", "svelte-13zdxo0");
    			add_location(li13, file$2, 70, 8, 2787);
    			attr_dev(span13, "class", "datetime svelte-13zdxo0");
    			add_location(span13, file$2, 74, 31, 2965);
    			attr_dev(li14, "class", "svelte-13zdxo0");
    			add_location(li14, file$2, 74, 8, 2942);
    			attr_dev(span14, "class", "datetime svelte-13zdxo0");
    			add_location(span14, file$2, 75, 37, 3046);
    			attr_dev(li15, "class", "svelte-13zdxo0");
    			add_location(li15, file$2, 75, 8, 3017);
    			add_location(ul5, file$2, 69, 6, 2774);
    			attr_dev(div5, "id", "careers__activities");
    			attr_dev(div5, "class", "careers__sections svelte-13zdxo0");
    			add_location(div5, file$2, 67, 4, 2668);
    			attr_dev(h36, "class", "subtitle svelte-13zdxo0");
    			add_location(h36, file$2, 79, 6, 3182);
    			attr_dev(span15, "class", "datetime svelte-13zdxo0");
    			add_location(span15, file$2, 81, 22, 3254);
    			attr_dev(li16, "class", "svelte-13zdxo0");
    			add_location(li16, file$2, 81, 8, 3240);
    			attr_dev(a4, "href", "https://www.credly.com/users/jonghyeon/badges");
    			attr_dev(a4, "target", "_blank");
    			add_location(a4, file$2, 82, 12, 3312);
    			add_location(br11, file$2, 82, 101, 3401);
    			add_location(br12, file$2, 83, 30, 3436);
    			attr_dev(li17, "class", "svelte-13zdxo0");
    			add_location(li17, file$2, 82, 8, 3308);
    			attr_dev(li18, "class", "svelte-13zdxo0");
    			add_location(li18, file$2, 86, 8, 3497);
    			attr_dev(li19, "class", "svelte-13zdxo0");
    			add_location(li19, file$2, 87, 8, 3522);
    			add_location(ul6, file$2, 80, 6, 3227);
    			attr_dev(div6, "id", "careers__certificates");
    			attr_dev(div6, "class", "careers__sections svelte-13zdxo0");
    			add_location(div6, file$2, 78, 4, 3117);
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(ul6, li17);
    			append_dev(li17, a4);
    			append_dev(li17, br11);
    			append_dev(li17, t84);
    			append_dev(li17, br12);
    			append_dev(li17, t85);
    			append_dev(ul6, t86);
    			append_dev(ul6, li18);
    			append_dev(ul6, t88);
