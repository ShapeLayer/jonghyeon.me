...
var app = (function () {
    ...
    const file$9 = "src/components/Symbols/ScrollGuide.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$8, 7, 23, 239);
    			attr_dev(span0, "id", "hero__trans-target-1");
    			attr_dev(span0, "class", "highlight svelte-1gc3qd7");
    			add_location(span0, file$8, 8, 11, 255);
    			add_location(br1, file$8, 8, 76, 320);
    			attr_dev(span1, "id", "hero__trans-target-2");
    			attr_dev(span1, "class", "highlight svelte-1gc3qd7");
    			add_location(span1, file$8, 9, 16, 341);
    			attr_dev(h10, "class", "hero__content pseudo svelte-1gc3qd7");
    			add_location(h10, file$8, 6, 6, 182);
    			add_location(br2, file$8, 11, 106, 524);
    			attr_dev(span2, "id", "hero__trans-target-1");
    			attr_dev(span2, "class", "highlight svelte-1gc3qd7");
    			add_location(span2, file$8, 11, 113, 531);
    			add_location(br3, file$8, 11, 178, 596);
    			attr_dev(span3, "id", "hero__trans-target-2");
    			attr_dev(span3, "class", "highlight svelte-1gc3qd7");
    			add_location(span3, file$8, 11, 190, 608);
    			attr_dev(a0, "class", "no-hover svelte-1gc3qd7");
    			attr_dev(a0, "href", "#profile");
    			add_location(a0, file$8, 11, 55, 473);
    			attr_dev(h11, "id", "hero__layer-shape");
    			attr_dev(h11, "class", "hero__content svelte-1gc3qd7");
    			add_location(h11, file$8, 11, 6, 424);
    			add_location(br4, file$8, 12, 107, 789);
    			attr_dev(span4, "id", "hero__trans-target-1");
    			attr_dev(span4, "class", "highlight svelte-1gc3qd7");
    			add_location(span4, file$8, 12, 114, 796);
    			add_location(br5, file$8, 12, 178, 860);
    			attr_dev(span5, "id", "hero__trans-target-2");
    			attr_dev(span5, "class", "highlight svelte-1gc3qd7");
    			add_location(span5, file$8, 12, 190, 872);
    			attr_dev(a1, "class", "no-hover svelte-1gc3qd7");
    			attr_dev(a1, "href", "#profile");
    			add_location(a1, file$8, 12, 55, 737);
    			attr_dev(h12, "id", "hero__shape-layer");
    			attr_dev(h12, "class", "hero__content svelte-1gc3qd7");
    			add_location(h12, file$8, 12, 6, 688);
    			attr_dev(div0, "class", "hero__wrapper svelte-1gc3qd7");
    			add_location(div0, file$8, 5, 4, 148);
    			attr_dev(div1, "class", "hero svelte-1gc3qd7");
    			add_location(div1, file$8, 4, 2, 125);
    			attr_dev(div2, "class", "scroll-guide svelte-1gc3qd7");
    			add_location(div2, file$8, 15, 2, 968);
    			attr_dev(header, "class", "svelte-1gc3qd7");
    			add_location(header, file$8, 3, 0, 114);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			br4 = element("br");
    			t15 = text("개인 정비 시간만 되면 사지방에 달려가는 군인");
    			t16 = space();
    			p5 = element("p");
    			...
    			t19 = space();
    			p7 = element("p");
    			p7.textContent = "안녕하세요. 학생과 개발자 사이, 박종현입니다.";
    			t21 = space();
    			div1 = element("div");
    			ul0 = element("ul");
    			li0 = element("li");
    			...
    			add_location(br4, file$7, 9, 29, 510);
    			attr_dev(p4, "class", "svelte-19h2xjl");
    			add_location(p4, file$7, 9, 6, 487);
    			attr_dev(p5, "class", "svelte-19h2xjl");
    			add_location(p5, file$7, 10, 6, 550);
    			add_location(br5, file$7, 11, 9, 579);
    			attr_dev(p6, "class", "svelte-19h2xjl");
    			add_location(p6, file$7, 11, 6, 576);
    			attr_dev(p7, "class", "svelte-19h2xjl");
    			add_location(p7, file$7, 12, 6, 594);
